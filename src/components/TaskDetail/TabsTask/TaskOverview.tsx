...
const TaskOverview = ({ task, isEditing, form, onEdit, onCancel, onSave, onDelete, teamId }: TaskOverviewProps) => {
    ...
    const renderStatusAndPriority = () => (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
                ...
                {isEditing ? (
                    <Form.Item name="priority" rules={[{ required: true, message: 'Vui lòng chọn độ ưu tiên!' }]}>
                        <Select
                            className="rounded-lg border-gray-300 hover:border-indigo-500 focus:border-indigo-500 shadow-sm transition-all duration-300"
                            allowClear
